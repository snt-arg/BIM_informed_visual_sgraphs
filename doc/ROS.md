# 🤖 ROS Topics and Parameters in ivS-Graphs

ivS-Graphs interfaces with several ROS topics to process sensor data, publish semantic insights, and support modular integrations. The topics are available below:
...
> 💡 To customize input topics and other parameters at launch time, please refer to the [⚙️ ivS-Graphs Launch Arguments](../launch/README.md) page for a full list and descriptions.
