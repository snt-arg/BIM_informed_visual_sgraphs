...
namespace ORB_SLAM3
{
    ...
    // void Map::AddMapBIMWall(Plane *pBIMWall)
    // {
    //     unique_lock<mutex> lock(mMutexMap);
    //     mspBIMWalls.insert(pBIMWall);
    //     // Add the BIM wall to the hashmap
    //     mBIMWallIndex[pBIMWall->getId()] = pBIMWall;
    // }
    ...
    // Plane *Map::GetBIMWallById(int wallId)
    // {
    //     unique_lock<mutex> lock(mMutexMap);
    //     Plane *fetchedBIMWall = mBIMWallIndex[wallId];
    //     return fetchedBIMWall;
    // }
    ...
    // void Map::EraseMapBIMWall(Plane *pBIMWall)
    // {
    //     unique_lock<mutex> lock(mMutexMap);
    //     mspBIMWalls.erase(pBIMWall);
    // }
    ...
    // vector<Plane *> Map::GetAllBIMWalls()
    // {
    //     unique_lock<mutex> lock(mMutexMap);
    //     return vector<Plane *>(mspBIMWalls.begin(), mspBIMWalls.end());
    // }
