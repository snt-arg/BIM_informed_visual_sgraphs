...
namespace ORB_SLAM3
{
    ...
    // std::vector<Plane *> Atlas::GetAllBIMWalls()
    // {
    //     unique_lock<mutex> lock(mMutexAtlas);
    //     return mpCurrentMap->GetAllBIMWalls();
    // }

    // void Atlas::AddBIMWall(Plane* wall) { // used in System.cc
    //     mvBIMWalls.push_back(wall);
    // }

    // std::vector<Plane*> Atlas::GetAllBIMDatabase() const {
    //     return mvBIMWalls;
    // }
