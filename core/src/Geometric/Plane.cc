...
namespace ORB_SLAM3
{
    ...
    int Plane::getBIMId() const
    {
        return bimId;
    }

    void Plane::setBIMId(int value)
    {
        bimId = value;
    }

    void Plane::setLength(float value)
    {
        length = value;
    }
    ...
    void Plane::setStartX(float value)
    {
        start_X = value;
    }

    float Plane::getStartX() const
    {
        return start_X;
    }


    float Plane::getStartY() const
    {
        return start_Y;
    }

    void Plane::setStartY(float value)
    {
        start_Y = value;
    }

    float Plane::getStartZ() const
    {
        return start_Z;
    }

    void Plane::setStartZ(float value)
    {
        start_Z = value;
    }
