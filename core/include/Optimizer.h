...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        void static GlobalAGraphBundleAdjustment(Atlas *pAtlas, Map *pMap, int nIterations = 5, bool *pbStopFlag = NULL,
        ...
        void static LocalBundleAdjustment(Atlas *pAtlas,KeyFrame *pKF, bool *pbStopFlag, Map *pMap, int &countFixedKF, int &num_OptKF,
