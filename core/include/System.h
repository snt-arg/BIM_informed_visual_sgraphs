...
public:
    ...
    System(
      const string & strVocFile, const string & strSettingsFile, const string & strSysParamsFile,
    ...
    void UpdateWallsFromMsg(const vs_graphs::msg::BIMWallDataArray & BimMarkers);
    void UpdateWallsFromMarkers(const visualization_msgs::msg::MarkerArray & BimMarkers);
    ...
    std::vector < Plane * > GetAllBIMWalls();
    ...
    void setSkeletonCluster(
      ...
      Eigen::Vector3d >> &skeletonClusterPoints);
