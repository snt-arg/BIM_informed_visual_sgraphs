...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // BIM database accessors       
        ORB_SLAM3::BIMDatabase& GetBIMDatabase() { 
            return mBIMDatabase; 
        }
        const ORB_SLAM3::BIMDatabase& GetBIMDatabase() const { 
            return mBIMDatabase; 
        }
        // void AddBIMWall(Plane* wall);
        // std::vector<Plane*> GetAllBIMDatabase() const;
    ...
    protected:
        ...
        // BIM database containers
        ORB_SLAM3::BIMDatabase mBIMDatabase;
        // std::vector<Plane*> mvBIMWalls;
