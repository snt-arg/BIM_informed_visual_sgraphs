...
namespace ORB_SLAM3
{
    ...
    public:
        ...
        // void AddMapBIMWall(Plane *pBIMWall);
        ...
        // void EraseMapBIMWall(Plane *pBIMWall);
        ...
        // Plane *GetBIMWallById(int wallId);
    ...
    protected:
        ...
        // std::unordered_map<int, Plane *> mBIMWallIndex;
