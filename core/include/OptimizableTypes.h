...
namespace ORB_SLAM3
{
    class Edge2Planes : public g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexPlane, g2o::VertexPlane> {
    public:
        EIGEN_MAKE_ALIGNED_OPERATOR_NEW
        
        Edge2Planes() : g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexPlane, g2o::VertexPlane>() {
        ...
        void computeError() override {
            ...
            // std::cout<<" v1 fixed: "<<v1->fixed()<<" v2 fixed: "<<v2->fixed()<<std::endl;
            // std::cout<<"information matrix: "<<_information.matrix() <<std::endl;
            // std::cout<<"plane1: ID:  "<<v1->id()<<"BEFORE: "<<plane1.normal().transpose()<<" dist: "<<plane1.distance()<<std::endl;
            // std::cout<<"plane2: ID:  "<<v2->id()<<" BEFORE: "<<plane2.normal().transpose()<<" dist: "<<plane2.distance()<<std::endl;
            _error = plane1.ominus(plane2);
            // print the error for debugging
            // std::cout<<"plane1: AFTER "<<plane1.normal().transpose()<<" dist: "<<plane1.distance()<<std::endl;
            // std::cout<<"plane2: AFTER "<<plane2.normal().transpose()<<" dist: "<<plane2.distance()<<std::endl;
            // std::cout << "Error in ominus: " << _error.transpose() << std::endl;
