...
namespace ORB_SLAM3
{
    ...
    private:
        ...
        int bimId;                                          // The plane's identifier in the local graph
        ...
        // Added BIM_WALL variant    
        // variables to store
        float length;                                    // The length of the plane
        float thickness; 
        float start_X; 
        float start_Y;                                 // The thickness of the plane
        float start_Z; 
