# ⚙️ ivS-Graphs Launch Arguments

This file documents the available _launch-time arguments_ that can be passed when launching `ivS-Graphs`. Default values mainly represent **RealSense D435** camera settings.
...
To use the [ICL dataset](https://www.doc.ic.ac.uk/~ahanda/VaFRIC/iclnuim.html) rosbags with `ivS-Graphs`, set the appropriate parameters as shown below:
...
To use the [OpenLoris dataset](https://lifelong-robotic-vision.github.io/dataset/scene.html) rosbags with `ivS-Graphs`, set the appropriate parameters as shown below:
...
To use the [ScanNet dataset](http://www.scan-net.org/) rosbags with `ivS-Graphs`, set the appropriate parameters as shown below:
...
To use the [TUM RGB-D dataset](https://cvg.cit.tum.de/data/datasets/rgbd-dataset) rosbags with `ivS-Graphs`, set the appropriate parameters as shown below:
