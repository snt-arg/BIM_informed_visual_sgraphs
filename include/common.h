...
extern std::string frameCamera, frameImu, frameWorld, frameMap, frameBC, frameSE, frameBIM;
...
// BIM data publishers
extern rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pubBIMWalls;
// extern rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pubLocalBAGraph;
...
// Future functions:
// void publishBIMRooms(const std::vector<ORB_SLAM3::Room*>& bimRooms, rclcpp::Time msgTime);
// void publishBIMDoors(const std::vector<ORB_SLAM3::Door*>& bimDoors, rclcpp::Time msgTime);
...
// /**
//  * @brief Gets BIM markers from `` to be processed
//  * @param skeletonArray The array of skeleton voxels received
//  */
// void setBimWalls(const visualization_msgs::msg::MarkerArray &wallsArray);
