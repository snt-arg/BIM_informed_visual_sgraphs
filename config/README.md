# 🚀 Configure ivS-Graphs

This guide outlines the core configuration parameters for running SLAM using **ivS-Graphs**, independent of the `ROS`-related settings. These parameters are stored in [system_params.yaml](/config/system_params.yaml).
